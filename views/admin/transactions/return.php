<?php
/**
 * Return Book View — included by TransactionController::returnBook()
 * Variables: $error (string), $borrow (array|null)
 */
if (!defined('BASE_PATH')) {
    require_once __DIR__ . '/../../../config/config.php';
    require_once __DIR__ . '/../../../includes/middleware.php';
    require_once __DIR__ . '/../../../controllers/TransactionController.php';
    (new TransactionController())->returnBook();
    exit;
}
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb">
            <a href="<?= BASE_URL ?>/views/admin/transactions/index.php">Transactions</a> / Return
          </p>
        </div>
      ...
      <div style="max-width:700px;">
        ...
        <div class="card mb-4">
          <div class="card-header">
            <i class="fas fa-search" style="color:var(--primary);margin-right:8px;"></i>Find Transaction
          </div>
          <div class="card-body">
            <form method="GET" style="display:flex;gap:12px;">
              <input type="text" name="issue_number"
                     value="<?= e($_GET['issue_number'] ?? '') ?>"
                     class="form-control"
                     placeholder="Enter Issue Number (e.g. ISS20240601ABCD12)">
          ...
          <div class="card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
              ...
              <div>
                ...
                <p class="<?= $overdue ? 'text-danger fw-bold' : '' ?>">
        ...
        <div class="alert alert-warning">
          <i class="fas fa-exclamation-triangle"></i>
          No active borrow found for that issue number.
        </div>
        <?php endif; ?>
      </div>
    </div>
