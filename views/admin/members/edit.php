<?php
/**
 * Edit Member View — included by MemberController::edit()
 * Variables: $error (string), $member (array)
 */
if (!defined('BASE_PATH')) {
    require_once __DIR__ . '/../../../config/config.php';
    require_once __DIR__ . '/../../../includes/middleware.php';
    require_once __DIR__ . '/../../../controllers/MemberController.php';
    (new MemberController())->edit();
    exit;
}
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb">
            <a href="<?= BASE_URL ?>/views/admin/members/index.php">Members</a> / Edit
          </p>
        </div>
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="card mb-4">
            <div class="card-header">
              <i class="fas fa-user" style="color:var(--primary);margin-right:8px;"></i>Personal Information
            </div>
            <div class="card-body">
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="form-group">
                  <label>Full Name <span style="color:var(--danger);">*</span></label>
                  <input type="text" name="full_name" value="<?= e($member['full_name']) ?>"
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="student_id" value="<?= e($member['student_id'] ?? '') ?>"
                         class="form-control">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <p class="form-text">Leave blank to keep current photo.</p>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-4">
            <div class="card-header">
              <i class="fas fa-id-card" style="color:var(--success);margin-right:8px;"></i>Membership Details
            </div>
            <div class="card-body">
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="form-group">
                  ...
                  <input type="date" name="membership_date"
                         value="<?= $member['membership_date'] ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Expiry Date</label>
                  <input type="date" name="expiry_date"
                         value="<?= $member['expiry_date'] ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Max Borrow Limit</label>
                  <input type="number" name="max_borrow_limit"
                         value="<?= $member['max_borrow_limit'] ?>"
