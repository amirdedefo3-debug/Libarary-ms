<?php
/**
 * Add Member View — included by MemberController::create()
    ...
    <div class="page-content">
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb">
            <a href="<?= BASE_URL ?>/views/admin/members/index.php">Members</a> / Add
          </p>
        </div>
      ...
      <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="password" class="form-control"
                           value="Library@123" placeholder="Default: Library@123">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <input type="text" name="student_id" class="form-control"
                           value="<?= e($_POST['student_id'] ?? '') ?>">
                  </div>
                  <div class="form-group">
                    <label>Max Borrow Limit</label>
                    <input type="number" name="max_borrow_limit" class="form-control"
                           value="<?= e($_POST['max_borrow_limit'] ?? '5') ?>" min="1" max="20">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group">
              ...
              <div class="card-body" style="text-align:center;">
                <img id="photoPreview"
                     ...
                     style="width:120px;height:120px;object-fit:cover;border-radius:50%;
                            border:3px solid var(--border);margin-bottom:12px;">
        ...
        <div class="d-flex gap-2 mt-4">
          ...
          <a href="<?= BASE_URL ?>/views/admin/members/index.php" class="btn btn-secondary btn-lg">
            Cancel
          </a>
        </div>
      </form>
