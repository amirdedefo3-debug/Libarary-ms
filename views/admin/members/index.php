    ...
    <div class="page-content">
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb"><a href="<?= BASE_URL ?>/views/admin/dashboard.php">Dashboard</a> / Members</p>
        </div>
        <?php if (hasPermission('members.add')): ?>
        <a href="<?= BASE_URL ?>/views/admin/members/create.php" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add Member</a>
        <?php endif; ?>
      </div>
        ...
        <div class="card-body" style="padding:12px 20px;">
          <form method="GET" style="display:flex;gap:12px;">
            <div style="flex:1;position:relative;">
              ...
              <input type="text" name="search" value="<?= e($_GET['search'] ?? '') ?>" class="form-control" style="padding-left:36px;" placeholder="Search name, ID, email...">
            </div>
            <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i></button>
            <a href="<?= BASE_URL ?>/views/admin/members/index.php" class="btn btn-secondary"><i class="fas fa-times"></i></a>
          </form>
        </div>
      </div>
        ...
        <div class="table-wrapper" style="border:none;border-radius:0;">
          <table>
            ...
            <tbody>
              ...
              <tr><td colspan="8" class="text-center text-muted" style="padding:40px;">No members found.</td></tr>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex gap-2">
                    <a href="<?= BASE_URL ?>/views/admin/members/show.php?id=<?= $m['id'] ?>" class="btn btn-sm btn-secondary" title="View"><i class="fas fa-eye"></i></a>
                    <?php if (hasPermission('members.edit')): ?>
                    <a href="<?= BASE_URL ?>/views/admin/members/edit.php?id=<?= $m['id'] ?>" class="btn btn-sm btn-primary" title="Edit"><i class="fas fa-edit"></i></a>
                    <?php endif; ?>
                    ...
                    <form method="POST" action="<?= BASE_URL ?>/views/admin/members/delete.php" style="display:inline;">
                      ...
                      <button type="submit" class="btn btn-sm btn-danger" data-confirm="Delete member <?= e(addslashes($m['full_name'])) ?>?"><i class="fas fa-trash"></i></button>
                    </form>
                    <?php endif; ?>
                  </div>
                </td>
