<?php
/**
 * Overdue Books View — included by TransactionController::overdue()
 * Variables: $transactions (array)
 */
if (!defined('BASE_PATH')) {
    require_once __DIR__ . '/../../../config/config.php';
    require_once __DIR__ . '/../../../includes/middleware.php';
    require_once __DIR__ . '/../../../controllers/TransactionController.php';
    (new TransactionController())->overdue();
    exit;
}
    ...
    <div class="page-content">
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb">
            <a href="<?= BASE_URL ?>/views/admin/transactions/index.php">Transactions</a> / Overdue
          </p>
        </div>
      </div>
      ...
      <?php if (empty($transactions)): ?>
        <div class="alert alert-success">
          <i class="fas fa-check-circle"></i> No overdue books right now!
        </div>
      <?php else: ?>
      <div class="card">
        <div class="card-header">
          <span class="text-danger">
            <i class="fas fa-exclamation-triangle"></i> <?= count($transactions) ?> Overdue Books
          </span>
        </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?= e($tx['full_name']) ?><br>
                  <small class="text-muted"><?= e($tx['member_code']) ?></small>
                </td>
                ...
                <td>
                  <a href="<?= BASE_URL ?>/views/admin/transactions/return.php?issue_number=<?= urlencode($tx['issue_number']) ?>"
