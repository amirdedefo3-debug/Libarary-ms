<?php
/**
 * Transactions List View — included by TransactionController::index()
 * Variables: $transactions (array), $pagination (array), $filters (array)
 */
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-breadcrumb">
            <a href="<?= BASE_URL ?>/views/admin/dashboard.php">Dashboard</a> / Transactions
          </p>
        </div>
          ...
          <form method="GET" style="display:flex;gap:12px;">
            ...
            <div style="flex:1;position:relative;">
              ...
              <input type="text" name="search" value="<?= e($filters['search']) ?>"
                     ...
                     placeholder="Search member, book, issue number...">
            </div>
            <button type="submit" class="btn btn-primary"><i class="fas fa-search"></i></button>
            <a href="?status=<?= e($_GET['status'] ?? '') ?>" class="btn btn-secondary">
